...
class ServerComponentRequest extends Request {
    ...
    isRscRequest() {
        ...
        return url.pathname === constants_1.RSC_PATHNAME;
    }
    savePreloadQuery(query) {
        if (typeof query.preload === 'string' && query.preload === PRELOAD_ALL) {
            ...
            this.ctx.preloadQueries.set((0, hash_1.hashKey)(query.key), query);
        }
    }
    getPreloadQueries() {
...
function saveToPreloadAllPreload(query) {
    ...
    setCache === null || setCache === void 0 ? void 0 : setCache.set((0, hash_1.hashKey)(query.key), query);
