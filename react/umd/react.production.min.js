...
};c.unstable_createMutableSource=function(a,b){return{_getVersion:b,_source:a,_workInProgressVersionPrimary:null,_workInProgressVersionSecondary:null}};c.unstable_getCacheForType=function(a){return e.current.getCacheForType(a)};c.unstable_getCacheSignal=function(){return e.current.getCacheSignal()};c.unstable_useCacheRefresh=function(){return e.current.useCacheRefresh()};c.useCallback=function(a,b){return e.current.useCallback(a,b)};c.useContext=function(a){return e.current.useContext(a)};c.useDebugValue=
function(a,b){};c.useDeferredValue=function(a){return e.current.useDeferredValue(a)};c.useEffect=function(a,b){return e.current.useEffect(a,b)};c.useId=function(){return e.current.useId()};c.useImperativeHandle=function(a,b,c){return e.current.useImperativeHandle(a,b,c)};c.useInsertionEffect=function(a,b){return e.current.useInsertionEffect(a,b)};c.useLayoutEffect=function(a,b){return e.current.useLayoutEffect(a,b)};c.useMemo=function(a,b){return e.current.useMemo(a,b)};c.useReducer=function(a,b,
c){return e.current.useReducer(a,b,c)};c.useRef=function(a){return e.current.useRef(a)};c.useState=function(a){return e.current.useState(a)};c.useSyncExternalStore=function(a,b,c){return e.current.useSyncExternalStore(a,b,c)};c.useTransition=function(){return e.current.useTransition()};c.version="18.0.0-rc.2-experimental-2bf7c02f0-20220314"});
})();
